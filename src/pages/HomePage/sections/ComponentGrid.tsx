...
const ComponentGrid = () => {
    ...
    return (
        <section className="relative py-20 md:py-32 px-4 sm:px-6 max-w-[1400px] mx-auto w-full">
            ...
            {/* Grid */}
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-5 md:gap-6 relative z-10">
                {featuredComponents.map((comp) => {
                    ...
                    return (
                        <div
                            ...
                            className="group relative h-[240px] sm:h-[260px] md:h-[280px] lg:h-[300px] bg-[#030303] rounded-3xl overflow-hidden flex items-center justify-center cursor-pointer select-none transition-all duration-500 hover:-translate-y-1 isolate"
                            style={{
                        ...
                        >
                            ...
                            <div className="absolute bottom-0 left-0 right-0 z-30 flex items-center justify-between px-6 py-5 pointer-events-none">
                                ...
                                <div className="w-7 h-7 rounded-full border border-white/5 bg-[#030303] flex items-center justify-center group-hover:border-white/15 group-hover:bg-white/[0.02] transition-all duration-500">
                                    <ArrowUpRight
                                        size={12}
                                        className="shrink-0 text-white/20 group-hover:text-white/60 transition-colors duration-500"
                                    />
                                </div>
                            </div>
                            ...
                            {/* Active border glow */}
                            {isActive && (
                                <div className="absolute inset-0 rounded-3xl ring-1 ring-brand-green/20 shadow-[0_0_30px_-5px_var(--color-brand-green,rgba(255,255,255,0.1))] pointer-events-none z-40 transition-all duration-500 opacity-50" />
                            )}
                        </div>
                    );
                })}
            ...
            <div className="mt-16 md:mt-24 flex justify-center z-10 relative">
                <button
                    ...
                    className="group relative flex items-center gap-3 px-8 py-3.5 rounded-full border border-white/[0.05] hover:border-white/[0.15] transition-all duration-500 cursor-pointer overflow-hidden backdrop-blur-md bg-black/50"
                >
                    ...
                    <ArrowUpRight size={14} className="text-white/40 group-hover:text-white transition-colors duration-500 relative z-10" />
                </button>
            </div>
        </section>
    );
