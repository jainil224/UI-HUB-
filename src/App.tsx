...
import backgroundVideo from './Assets/Orange_neon_light_strips_animate_54db056d87.mp4';
...
const Navbar = () => (
  <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-4 bg-brand-black/80 backdrop-blur-md border-b border-white/5">
    ...
    <div className="flex items-center gap-4">
      ...
      <button className="bg-brand-green text-black px-4 py-1.5 rounded-full text-sm font-bold hover:bg-white hover:text-black transition-all">
        Get Started
      </button>
    </div>
  </nav>
...
const SectionHeader = ({ title, subtitle, id }: { title: string; subtitle: string; id: string }) => (
  <div id={id} className="mb-12">
    <div className="flex items-center gap-3 mb-2">
      ...
      <span className="text-brand-green text-xs font-bold uppercase tracking-widest">{subtitle}</span>
    </div>
  ...
  return (
    <section id="hero" className="relative min-h-screen flex flex-col items-center justify-center px-6 pt-20 overflow-hidden">
      ...
      >
        ...
        <h1 className="text-7xl md:text-[10rem] font-display leading-[0.85] uppercase tracking-tighter mb-8 shadow-black/50 drop-shadow-2xl">
          Craft the <br />
          <span className="text-brand-green">Future</span> of UI
        </h1>

        <p className="max-w-xl mx-auto text-white/80 text-lg md:text-xl mb-12 font-light leading-relaxed drop-shadow-md">
      ...
      <div className="mt-24 w-full max-w-6xl grid grid-cols-1 md:grid-cols-3 gap-6 opacity-60 hover:opacity-100 transition-opacity duration-700 z-30">
        <div className="glass p-6 rounded-2xl flex items-center gap-4">
          <div className="w-12 h-12 rounded-xl bg-white/5 flex items-center justify-center">
            <Layers size={24} className="text-brand-green" />
          </div>
          <div>
            <div className="text-xs text-white/60 font-bold uppercase tracking-widest">Components</div>
            <div className="text-xl font-bold">500+ Assets</div>
          </div>
        </div>
        <div className="glass p-6 rounded-2xl flex items-center gap-4">
          <div className="w-12 h-12 rounded-xl bg-white/5 flex items-center justify-center">
            <MousePointer2 size={24} className="text-brand-green" />
          </div>
          <div>
            <div className="text-xs text-white/60 font-bold uppercase tracking-widest">Interactions</div>
            <div className="text-xl font-bold">Smooth Motion</div>
          </div>
        </div>
        <div className="glass p-6 rounded-2xl flex items-center gap-4">
          <div className="w-12 h-12 rounded-xl bg-white/5 flex items-center justify-center">
            <Layout size={24} className="text-brand-green" />
          </div>
          <div>
            <div className="text-xs text-white/60 font-bold uppercase tracking-widest">Layouts</div>
  ...
  <footer className="py-12 px-6 border-t border-white/5 bg-black">
    <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
      ...
      <div className="flex items-center gap-6">
        <Twitter size={20} className="text-white/40 hover:text-brand-green cursor-pointer transition-colors" />
        <Github size={20} className="text-white/40 hover:text-brand-green cursor-pointer transition-colors" />
