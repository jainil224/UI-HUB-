...
<img src="https://capsule-render.vercel.app/api/render?type=waving&color=0:000000,50:00FF1A,100:000000&height=200&section=header&text=UI%20HUB%202.0&fontSize=70&fontColor=00FF1A&animation=fadeIn&fontAlignY=38&desc=Craft%20the%20Future%20of%20UI&descAlignY=60&descSize=20&descColor=ffffff" width="100%" />

<br/>

<p align="center">
  <img src="https://img.shields.io/badge/Author-Jainil%20Patel-00FF1A?style=for-the-badge&logo=github&logoColor=black" alt="Author" />
  <img src="https://img.shields.io/badge/Version-2.0-00FF1A?style=for-the-badge&logo=rocket&logoColor=black" alt="Version" />
  <img src="https://img.shields.io/badge/Status-Live-00FF1A?style=for-the-badge&logo=statuspage&logoColor=black" alt="Status" />
  <img src="https://img.shields.io/badge/License-MIT-00FF1A?style=for-the-badge&logo=opensourceinitiative&logoColor=black" alt="License" />
</p>
...
```mermaid
sequenceDiagram
    User->>Firebase: Login (Google/GitHub/Email)
    Firebase->>AuthContext: onAuthStateChanged fires
    AuthContext->>Backend API: POST /api/v1/users/sync (idToken)
    Backend API->>Firebase Admin: verifyIdToken() → uid/email
    Backend API->>MongoDB: upsert user + log user.created/user.login
    Backend API->>Firebase: create Firestore user doc, queue welcome emails
    AuthContext->>Backend API: GET /api/v1/users/status (Bearer token)
    Backend API->>MongoDB: check plan tier (Free/Pro/Elite)
    Backend API->>AuthContext: { isPro, isElite, trial, plan }
    AuthContext->>App: User state + tier available globally
```
...
<p>
  <a href="https://github.com/jainil224">
    <img src="https://img.shields.io/badge/GitHub-jainil224-00FF1A?style=for-the-badge&logo=github&logoColor=black" />
  </a>
</p>
...
<img src="https://capsule-render.vercel.app/api/render?type=waving&color=0:000000,50:00FF1A,100:000000&height=120&section=footer&text=Craft%20the%20Future%20of%20UI&fontSize=24&fontColor=00FF1A&animation=fadeIn" width="100%" />
