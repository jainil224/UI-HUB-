...
export const search = {
    ...
    usage: 'ui-hub search [query] [--kind components|templates|animations] [--category <cat>] [--framework react] [--styling tailwind|css|scss] [--tags a,b] [--premium|--free] [--json]',
    async run(ctx, args) {
        ...
        if (!tool)
            usage(`Unknown kind "${kind}". Use components, templates, or animations.`);
        const params = {};
        if (query)
            params.query = query;
