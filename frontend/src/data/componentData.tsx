    ...
    return (
        <div style={{
            ...
            <div style={{
                ...
                {/* Truck layer - scaled and perfectly blended without visible image edges */}
                <div style={{
                    position: 'absolute',
                    inset: '0 0 0 0',
                    bottom: 0,
...
const SuiSteppedGraphic: React.FC<{ style?: React.CSSProperties }> = ({ style }) => {
    const containerRef = useRef<HTMLDivElement>(null);
    ...
    useEffect(() => {
        ...
        const render = () => {
            ...
            const numSteps = SUI_STEPS.length;
            ...
            SUI_STEPS.forEach((step, i) => {
                const x = i * colWidth;
                const colH = height * step.heightRatio;
                const y = height - colH;

                const colGrad = ctx.createLinearGradient(0, y, 0, height);
                colGrad.addColorStop(0.0, 'rgba(1, 6, 20, 0.0)');
                colGrad.addColorStop(0.06, 'rgba(4, 18, 55, 0.55)');
                colGrad.addColorStop(0.20, 'rgba(8, 38, 120, 0.86)');
                colGrad.addColorStop(0.42, 'rgba(18, 78, 210, 0.96)');
                colGrad.addColorStop(0.68, 'rgba(38, 115, 248, 1.0)');
                colGrad.addColorStop(0.86, 'rgba(120, 180, 255, 1.0)');
                colGrad.addColorStop(0.96, 'rgba(220, 238, 255, 1.0)');
                colGrad.addColorStop(1.0, 'rgba(255, 255, 255, 1.0)');
            ...
            for (let p = 0; p < len; p += 4) {
                ...
                if (alpha > 5) {
                    ...
                    data[p] = Math.min(255, Math.max(0, data[p] + noise * 0.8));
                    data[p + 1] = Math.min(255, Math.max(0, data[p + 1] + noise * 0.9));
                    data[p + 2] = Math.min(255, Math.max(0, data[p + 2] + noise * 1.15));
                }
            }
            ...
            for (let i = 1; i < numSteps; i++) {
                ...
                const stepH = Math.max(SUI_STEPS[i - 1].heightRatio, SUI_STEPS[i].heightRatio);
...
export const SuiFoundationPreview = () => {
    const communityLinks = [
        "Upcoming events", "Event recaps", "SuiHub", "Online communities",
    ];
    const aboutLinks = [
        "About Sui Foundation", "Brand kit", "Careers", "Terms of service", "Privacy policy",
    ];
    ...
    return (
        <div style={{
            ...
            <div style={{ width: "100%", maxWidth: 1280, margin: "0 auto", position: "relative", zIndex: 10 }}>
                {/* Sui Flame/Droplet Logo */}
                <div style={{ marginBottom: 32 }}>
                    <svg width="22" height="28" viewBox="0 0 24 32" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ filter: "drop-shadow(0 0 8px rgba(255,255,255,0.4))" }}>
                        <path d="M12 2.2C12 2.2 3.5 13.6 3.5 20.2C3.5 25.2 7.3 29.5 12 29.5C16.7 29.5 20.5 25.2 20.5 20.2C20.5 13.6 12 2.2 12 2.2ZM12 26.8C8.6 26.8 6 23.9 6 20.2C6 15.6 12 7.4 12 7.4C12 7.4 18 15.6 18 20.2C18 23.9 15.4 26.8 12 26.8Z" fill="#F5F5F5" />
                    </svg>
                </div>
                ...
                <div style={{
                    ...
                    {/* COMMUNITY */}
                    <div>
                        <div style={{ color: "#FFFFFF", fontSize: 13, fontWeight: 600, letterSpacing: "2px", textTransform: "uppercase", marginBottom: 12 }}>
                            COMMUNITY/
                        </div>
                        <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: 3 }}>
                            {communityLinks.map((item) => (
                                <li key={item} style={{ display: "flex", alignItems: "center" }}>
                                    <span style={{ color: "#55657E", userSelect: "none", marginRight: 8 }}>└─</span>
                                    <span style={{ color: "#8C9BAE" }}>{item}</span>
                                </li>
                            ))}
                        </ul>
                    </div>
                ...
                <div style={{ marginTop: 44, marginBottom: 28 }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 5, marginBottom: 14 }}>
                        {/* YouTube */}
                        <div style={{ width: 31, height: 29, background: "#D7DDE1", borderRadius: 2, display: "flex", alignItems: "center", justifyContent: "center" }}>
                            <svg width="15" height="15" viewBox="0 0 24 24" fill="#000000"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" /></svg>
                        </div>
                        {/* Discord */}
                        <div style={{ width: 31, height: 29, background: "#D7DDE1", borderRadius: 2, display: "flex", alignItems: "center", justifyContent: "center" }}>
                            <svg width="15" height="15" viewBox="0 0 24 24" fill="#000000"><path d="M20.317 4.37a19.791 19.791 0 0 0-4.885-1.515.074.074 0 0 0-.079.037c-.21.375-.444.864-.608 1.25a18.27 18.27 0 0 0-5.487 0 12.64 12.64 0 0 0-.617-1.25.077.077 0 0 0-.079-.037A19.736 19.736 0 0 0 3.677 4.37a.07.07 0 0 0-.032.027C.533 9.046-.32 13.58.099 18.057a.082.082 0 0 0 .031.057 19.9 19.9 0 0 0 5.993 3.03.078.078 0 0 0 .084-.028c.462-.63.874-1.295 1.226-1.994.021-.041.001-.09-.041-.106a13.107 13.107 0 0 1-1.872-.892.077.077 0 0 1-.008-.128 10.2 10.2 0 0 0 .372-.292.074.074 0 0 1 .077-.01c3.929 1.793 8.18 1.793 12.061 0a.074.074 0 0 1 .078.01c.12.098.246.198.373.292a.077.077 0 0 1-.006.127 12.299 12.299 0 0 1-1.873.894.077.077 0 0 0-.041.107c.36.698.772 1.362 1.225 1.993a.076.076 0 0 0 .084.028 19.839 19.839 0 0 0 6.002-3.03.077.077 0 0 0 .032-.054c.5-5.177-.838-9.674-3.549-13.66a.061.061 0 0 0-.031-.028zM8.02 15.33c-1.183 0-2.157-1.085-2.157-2.419 0-1.333.956-2.419 2.157-2.419 1.21 0 2.176 1.096 2.157 2.42 0 1.333-.956 2.418-2.157 2.418zm7.975 0c-1.183 0-2.157-1.085-2.157-2.419 0-1.333.955-2.419 2.157-2.419 1.21 0 2.176 1.096 2.157 2.42 0 1.333-.946 2.418-2.157 2.418z" /></svg>
                        </div>
                        {/* LinkedIn */}
                        <div style={{ width: 31, height: 29, background: "#D7DDE1", borderRadius: 2, display: "flex", alignItems: "center", justifyContent: "center" }}>
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="#000000"><path d="M19 3a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14m-.5 15.5v-5.3a3.26 3.26 0 0 0-3.26-3.26c-.85 0-1.84.52-2.28 1.3v-1.11h-2.79v8.37h2.79v-4.93c0-.77.62-1.4 1.39-1.4a1.4 1.4 0 0 1 1.4 1.4v4.93h2.75M6.46 8.76c.94 0 1.7-.76 1.7-1.7s-.76-1.7-1.7-1.7-1.7.76-1.7 1.7.76 1.7 1.7 1.7m1.4 9.74v-8.37H5.06v8.37h2.8z" /></svg>
                        </div>
                        {/* X */}
                        <div style={{ width: 31, height: 29, background: "#D7DDE1", borderRadius: 2, display: "flex", alignItems: "center", justifyContent: "center" }}>
                    ...
                    <p style={{ margin: 0, fontSize: 11.5, color: "#63738A", letterSpacing: "1px" }}>
                        ©2026 Copyright Sui Foundation. All rights reserved
                    </p>
                </div>
            </div>

            {/* Stepped Blue Graphic Canvas */}
            <SuiSteppedGraphic style={{ height: 280, marginTop: "auto" }} />
        </div>
    );
};
...
Live Link: https://ai.studio/apps/3a30febb-b24a-4b58-925a-0413fcf885cb`,
...

    {
        ...
        category: "footer",
        isPremium: false,
        liveUrl: "https://ai.studio/apps/e15c9ca4-119e-4483-a2a9-14b15669f991",
        addedAt: "2026-09-01",
        newBadgeDays: 120,
        description: "An exact pixel-accurate website footer reproduction of the Sui Foundation technical footer in React and Tailwind CSS, featuring a minimal dark terminal aesthetic, 4-column navigation with terminal connectors (└─), light gray square social pills, and an ambient glowing blue stepped equalizer graphic.",
        preview: () => (<SuiFoundationPreview />),
  ...
  return (
    <div className="w-full min-h-screen bg-[#000000] text-[#8C9BAE] font-mono select-text relative overflow-x-hidden flex flex-col justify-between pt-6 sm:pt-8 px-4 sm:px-6 md:px-8 pb-0">
      ...
      <SteppedGraphic className="h-[340px] sm:h-[420px] md:h-[480px] mt-auto" />
        ...
        vibePrompt: `Recreate the uploaded reference image as an EXACT pixel-accurate website footer.

IMPORTANT:
Use the uploaded image as the single source of truth. Do NOT redesign, modernize, simplify, or reinterpret it. Match the reference's layout, proportions, typography, spacing, colors, background effects, icon placement, and visual hierarchy as closely as possible.

========================================
OVERALL FOOTER
========================================

Create a full-width, full-viewport-height footer section.

Background:
- Pure black / near-black: #000000
- No visible outer container.
- No rounded corners.
- No card styling.
- The entire viewport should use the black footer background.

The footer has:
1. Small logo at top-left
2. Four main navigation areas
3. Community/About subsections
4. Social media icons
5. Copyright text
6. Large blue glowing stepped graphic at the bottom

========================================
1. TOP-LEFT LOGO
========================================

Place a small white abstract Sui-style droplet/flame logo in the extreme top-left.

Position:
- Approximately 18px from left
- Approximately 24px from top
- Width approximately 22px
- Height approximately 28px

Color:
- White / #F5F5F5

Keep the logo simple and thin.

If an exact logo asset exists in the project, use it.
Otherwise recreate it using SVG.

========================================
2. MAIN FOOTER GRID
========================================

Create a four-column navigation layout.

The columns should be positioned approximately:
...
On a large desktop viewport, distribute them similarly to the reference.

The navigation begins approximately 110px from the top.

Do NOT center all content.
The reference uses a strong left-aligned editorial grid.
...
- Medium weight
- Uppercase
- Monospaced / technical appearance
- Example:
...
Prefer the project's existing monospace font if available.
...
IMPORTANT:
Every link begins with a small L-shaped / terminal-style connector:

└─

The connector should be muted gray.
...
Keep the spacing and indentation identical to the reference.

========================================
5. COLUMN 2 — SOLUTIONS
========================================
...
========================================
7. COLUMN 3 — COMMUNITY
========================================

Below DEVELOPERS, add another subsection.
...
Maintain a noticeable vertical gap between DEVELOPERS and COMMUNITY.

========================================
8. COLUMN 4 — RESOURCES
========================================
...
Maintain the same vertical spacing shown in the reference.

========================================
10. LINK DETAILS
========================================

All navigation links should:

- Be left aligned.
- Use monospace typography.
- Have muted gray-blue color.
- Have generous but compact vertical spacing.
- Use the same connector indentation.
- Avoid bullets.
- Avoid standard HTML list bullets.
- Use custom CSS/SVG/characters for the connector.
...
The connector and text should feel like a terminal/developer interface.

========================================
11. SOCIAL MEDIA AREA
========================================

Position social icons near the bottom-left.

Approximately:
- 18px from left
- 770px from top on a 1300×1150 style viewport

Create four square social buttons:
...
Each icon should be inside a small square.
...
There should be approximately 5px spacing between buttons.

Use recognizable simple icons.

========================================
12. COPYRIGHT
========================================

Below the social buttons, place:
...
- monospace
- approximately 12px
- letter spacing approximately 1px

Position approximately 18px from the left.

========================================
13. BOTTOM BLUE GRAPHIC
========================================

THIS IS ONE OF THE MOST IMPORTANT VISUAL ELEMENTS.

At the bottom of the page create a large stepped/equalizer-like abstract blue graphic.

It consists of multiple vertical rectangular columns rising from the bottom.

There are approximately 7 visible sections.

The structure should look approximately like:
...
But reproduce the exact stepped heights from the reference.

The graphic spans the FULL WIDTH of the viewport.

========================================
14. BLUE GRADIENT
========================================

The bottom stepped graphic should use a blue glow/gradient.

Colors transition vertically:
...
Bottom:
- very light blue/white glow
- approximately #BBD4FF / #E6EEFF

The gradient should fade smoothly.

Each column should have a subtle blue noise/grain texture.

Do NOT make the graphic look like simple flat rectangles.

========================================
15. COLUMN EDGES
========================================

Each blue vertical block should have extremely subtle dotted/technical borders along its vertical edges.

The dotted lines should be:
...
This detail is important because it gives the bottom graphic its technical aesthetic.
...
The glow should become brighter toward the bottom.

Keep the upper part mostly black.

========================================
17. EXACT COMPOSITION
========================================

The final composition should visually follow:

[small white logo]

PLATFORM/          SOLUTIONS/          DEVELOPERS/          RESOURCES/
└─ ...             └─ ...              └─ ...              └─ ...
└─ ...             └─ ...              └─ ...              └─ ...
└─ ...                                  └─ ...
└─ ...                                  └─ ...
...
DESKTOP:
Match the uploaded reference as closely as possible.

TABLET:
- Reduce column spacing.
- Maintain four-column structure if enough width exists.
- Otherwise transition to two columns.

MOBILE:
- Stack navigation sections vertically.
- Keep the same typography.
- Keep social icons near the bottom.
- Keep the stepped blue graphic full width.
- Preserve the technical visual identity.

Do NOT introduce horizontal scrolling.

========================================
19. PIXEL-PERFECT REQUIREMENT
========================================

After implementation, compare the rendered website with the uploaded image.

Adjust until the visual composition is extremely close.
...
- hero section
- cards
- gradients outside the blue bottom graphic
- rounded containers
...
Keep the design minimal, technical, dark, and developer-focused.
