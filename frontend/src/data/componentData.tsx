...
Props: starSize, stiffness, damping, containerRef (for scoped use), hideDefaultCursor, className`
    ...
    },
    {
        ...
        code: `import { InfiniteMarquee } from '@/components/ui/InfiniteMarquee';\n\nexport default function Demo() {\n  const items = [\n    { text: "Components", link: "#", image: "https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?auto=format&fit=crop&w=600&q=80" },\n    { text: "Animations", link: "#", image: "https://images.unsplash.com/photo-1634017839464-5c339ebe3cb4?auto=format&fit=crop&w=600&q=80" },\n    { text: "Effects", link: "#", image: "https://images.unsplash.com/photo-1618005198143-e528346d9a99?auto=format&fit=crop&w=600&q=80" },\n    { text: "Backgrounds", link: "#", image: "https://images.unsplash.com/photo-1607604276583-eef5d076aa5f?auto=format&fit=crop&w=600&q=80" }\n  ];\n\n  return (\n    <div className="w-full h-[500px] rounded-3xl overflow-hidden border border-white/5">\n      <InfiniteMarquee \n        items={items} \n        speed={15} \n        textColor="#ffffff"\n        bgColor="#060010"\n        marqueeTextColor="#060010"\n        marqueeBgColor="#ffffff"\n      />\n    </div>\n  );\n}`,
