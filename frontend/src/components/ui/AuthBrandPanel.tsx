...
const AuthBrandPanel = ({
    ...
    return (
        <div className="relative w-full md:w-[45%] md:min-h-[580px] min-h-[200px] flex items-center justify-center p-6 md:p-10 overflow-hidden bg-gradient-to-br from-[#2540D6] via-[#3D5CFF] to-[#050A14]">
            ...
            <div className="relative z-10 flex flex-col items-center text-center gap-5">
                <Link to="/" className="hover:opacity-90 transition-opacity">
                    <Logo className="w-12 h-12 md:w-14 md:h-14" showText={false} color="#FFFFFF" />
                </Link>
                <div className="space-y-2">
                    <h2 className="text-2xl md:text-3xl font-heading font-black text-white uppercase tracking-tight">UI HUB</h2>
