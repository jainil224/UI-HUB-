...
/**
 * GearSystem
 * A mechanical gears loader. Three small counter-rotating gears and one large
 * slow gear interlock inside a dark gearbox, spinning with tooth bars that
 * radiate around each gear's axle.
 */
export const GearSystem: React.FC = () => {
    return (
        <div
