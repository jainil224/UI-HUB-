...
function __UIHUBBase_VectorWordmark(props: VectorWordmarkProps) {
    const {
        text = "VECTOR",
        font = {
            fontFamily: "Inter",
...
export default function VectorWordmark(props: Record<string, unknown>) {
  return <__UIHUBBase_VectorWordmark {...(__uiHubPresetProps as Record<string, unknown>)} {...props} />;
}