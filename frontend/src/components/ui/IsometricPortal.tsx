...
/**
 * IsometricPortal
 * A neo-brutalist isometric diamond loader. Two offset faceted frames "bounce"
 * apart while golden particles drift upward inside the portal and the shadow
 * gradient pulsing stop animates underneath the fill.
 */
export const IsometricPortal: React.FC = () => {
    return (
        <div
        ...
        >
            <style>{`
                ...
                #particles {
                    animation: ip-particles 4s ease-in-out infinite;
                }
                #animatedStop {
                    animation: ip-umbral 4s infinite;
                }
                #bounce {
                    animation: ip-bounce 4s ease-in-out infinite;
                    translate: 0px 36px;
                }
                #bounce2 {
                    animation: ip-bounce2 4s ease-in-out infinite;
                    translate: 0px 46px;
