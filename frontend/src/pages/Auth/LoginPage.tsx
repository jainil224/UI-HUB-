...
import { Mail, Lock, AlertCircle, Loader2, ArrowRight, Eye, EyeOff, Check } from 'lucide-react';
        ...
        <main className="relative min-h-screen w-full pt-16 flex items-center justify-center bg-brand-black text-white font-sans overflow-x-hidden px-4 py-10">
            ...
            <div className="relative z-10 w-full max-w-4xl flex flex-col gap-6">
                ...
                <div className="rounded-xl border-2 border-white bg-brand-surface brutal-shadow-black overflow-hidden flex flex-col md:flex-row">
                    ...
                    <div className="relative w-full md:w-[45%] md:min-h-[580px] min-h-[240px] flex items-center justify-center p-8 md:p-10 overflow-hidden bg-gradient-to-br from-[#2540D6] via-[#3D5CFF] to-[#050A14]">
                        ...
                        <div className="relative z-10 flex flex-col items-center text-center gap-5">
                            <Link to="/" className="hover:opacity-90 transition-opacity">
                                <Logo className="w-14 h-14" showText={false} color="#FFFFFF" />
                            </Link>
                            <div className="space-y-2">
                                <h2 className="text-3xl font-heading font-black text-white uppercase tracking-tight">UI HUB</h2>
                                <p className="text-[10px] font-bold text-white/80 uppercase tracking-[0.25em]">Premium Component Library</p>
                            </div>
                            <div className="h-px w-16 bg-white/25" />
                            <ul className="space-y-2.5">
                                {['60+ Animated Components', 'Drop-in React + Tailwind', '5 AI Vibe Prompts'].map(feat => (
