...
const LoginPage = () => {
    ...
    return (
        <main className="min-h-screen w-full pt-16 flex flex-col lg:flex-row bg-[#EBEBEB] text-black font-sans overflow-x-hidden">
            ...
            {/* ========================================================
                LEFT SIDE: Bauhaus Graphic Column (50% Width)
                ======================================================== */}
            <div className="w-full lg:w-1/2 min-h-[420px] lg:min-h-[calc(100vh-64px)] bg-[#1F4BFF] text-white p-8 md:p-12 lg:p-16 flex flex-col justify-between relative overflow-hidden border-b-4 lg:border-b-0 lg:border-r-4 border-black">
                ...
                <div className="absolute top-12 right-12 w-20 h-20 md:w-24 md:h-24 rounded-full bg-[#E52520] border-2 border-black shadow-[4px_4px_0px_0px_#000000] pointer-events-none z-10" />
                ...
                <div className="relative z-20 my-auto py-10 max-w-lg">
                    <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black uppercase tracking-tight leading-[1.05] mb-6">
                        ENTER THE<br />
                        <span className="text-[#FFC700]">ENGINE.</span>
                    </h1>
                    <p className="text-white/90 text-sm sm:text-base font-medium leading-relaxed max-w-md">
                        Constructivist component repository. Access verified blueprints, copy production code, and inspect interactive UI patterns in real-time.
                    </p>
                </div>
                ...
                <div className="relative z-20 pt-6 border-t border-white/20 flex items-center justify-between text-xs font-bold uppercase tracking-wider text-white/80">
                    ...
                    <span className="font-mono text-[10px] text-white/60">SYSTEM ID // UI-2026</span>
                </div>
            </div>
            ...
            <div className="w-full lg:w-1/2 min-h-screen bg-[#EBEBEB] flex flex-col justify-center items-center p-6 md:p-12 lg:p-16">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="space-y-1.5">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    placeholder="••••••••"
                                    className="w-full bg-white border-2 border-black py-2.5 pl-10 pr-10 text-sm font-mono text-black placeholder:text-neutral-400 focus:outline-none focus:bg-[#FFFDF0] focus:shadow-[2px_2px_0px_0px_#000000] transition-all"
                                />
                                <button
                                    type="button"
                                    onClick={() => setShowPassword(!showPassword)}
                                    aria-label={showPassword ? 'Hide password' : 'Show password'}
                                    className="absolute right-1 top-1/2 -translate-y-1/2 p-2.5 text-neutral-600 hover:text-black transition-colors"
                                >
                        ...
                        <div className="flex items-center justify-between text-xs pt-1">
                            <label className="flex items-center gap-2 cursor-pointer select-none">
                                ...
                                />
                                <span className="text-[11px] font-black uppercase tracking-wider text-black">REMEMBER ME</span>
                            </label>

                            <Link to="/forgot-password" className="text-[11px] font-black uppercase tracking-wider text-[#1F4BFF] hover:underline">
                                FORGOT PASSWORD?
                            </Link>
                        </div>
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full bg-[#E52520] hover:bg-[#CC1E1A] text-white border-2 border-black py-3 px-4 text-xs font-black uppercase tracking-widest shadow-[4px_4px_0px_0px_#000000] active:translate-x-0.5 active:translate-y-0.5 active:shadow-[2px_2px_0px_0px_#000000] transition-all flex items-center justify-center gap-2"
                        >
                            {loading ? (
                ...
                <div className="mt-6 text-center">
                    <p className="text-xs font-bold uppercase tracking-wider text-black">
                        ...
                        <Link to="/signup" className="text-[#E52520] hover:underline font-black">
                            CREATE ONE FREE →
                        </Link>
                    </p>
                </div>
