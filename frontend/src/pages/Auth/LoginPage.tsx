    ...
    const handleSocialSignIn = async (providerType: 'google' | 'github') => {
        ...
        try {
            ...
            if (err.code === 'auth/popup-blocked') {
                setError('Authentication popup was blocked by your browser. Please allow popups for this site and try again.');
            } else {
        ...
        <main className="min-h-screen pt-20 md:pt-32 pb-10 md:pb-20 px-4 flex items-center justify-center relative overflow-hidden bg-[#020202]">
            ...
            <div className="w-full max-w-lg relative z-10">
                <div className="text-center mb-12">
                    ...
                    >
                        <Sparkles size={14} />
                        <span>Welcome to the Vault</span>
                    </motion.div>
                    ...
                    >
                        LOGIN TO <span className="text-brand-green text-glow">UI HUB</span>
                    </motion.h1>
                    <motion.p
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                    ...
                    <div className="p-6 md:p-8">
                        ...
                        >
                            ...
                            <div className="flex items-center gap-2">
                                <span className="text-white/20 text-[10px] font-black uppercase tracking-[0.3em] text-center">Sign in with UI Hub</span>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            >
                                ...
                                {loading ? (
                                    ...
                                    <>
                                        Login to UI Hub <ArrowRight size={18} className="group-hover:translate-x-1 transition-transform" />
                                    </>
                                )}
                            </motion.button>
                        </form>
                        ...
                        <div className="mt-12 pt-8 border-t border-white/5 text-center">
                            ...
                            <Link to="/signup" className="inline-flex items-center gap-2 text-brand-green hover:text-white transition-colors group px-6 py-3 rounded-xl bg-brand-green/5 border border-brand-green/10 hover:bg-brand-green/10">
                                <span className="text-[10px] font-black uppercase tracking-widest font-heading">Initiate Registration</span>
