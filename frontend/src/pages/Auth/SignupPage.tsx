                    ...
                    <div className="min-h-full flex flex-col py-12 lg:py-20">
                        ...
                        <div className="flex-1 flex flex-col justify-center w-full max-w-[480px] mx-auto">
                            ...
                            <h1 className="text-5xl lg:text-6xl font-black mb-4 tracking-tighter">
                                CREATE <span className="text-[#00FF88] drop-shadow-[0_0_20px_rgba(0,255,136,0.5)]">UI HUB</span>
                            </h1>
                            ...
                            <div className="flex items-center gap-4 mb-8">
                                ...
                                <span className="text-[10px] uppercase tracking-wider text-white/30 font-bold">Or register with email</span>
                                <div className="h-px bg-white/10 flex-1" />
                            </div>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-5">
                                ...
                                <div className="space-y-2">
                                    <label className="text-[11px] font-bold uppercase tracking-wider text-white/40 ml-1">Full Name</label>
                                    <div className="relative group">
                                        <User className="absolute left-4 top-1/2 -translate-y-1/2 text-white/20 group-focus-within:text-[#00FF88] transition-colors z-10 pointer-events-none" size={18} />
                                        <input
                                            type="text"
                                            required
                                            value={name}
                                ...
                                >
                                    ...
                                    {loading ? (
                                        ...
                                        <>
                                            Join Elite Access <ArrowRight size={16} className="group-hover:translate-x-1 transition-transform" />
                                        </>
                                    )}
                                </motion.button>
                            </form>
