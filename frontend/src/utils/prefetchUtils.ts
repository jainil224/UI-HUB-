...
const PREFETCH_MAP: Record<string, () => Promise<any>> = {
    ...
    'neural-network-background': () => import('../components/ui/NeuralNetworkBackground'),
    'black-hole-background': () => import('../components/ui/BlackHoleBackground'),
    'warp-speed-background': () => import('../components/ui/WarpSpeedBackground'),
    'mouse-gravity-background': () => import('../components/ui/MouseGravityBackground'),
    'particles-background': () => import('../components/ui/ParticlesBackground'),
    ...
    'shatter-button': () => import('../components/ui/shatter-button'),
    ...
    'neon-flicker-button': () => import('../components/ui/NeonFlickerButton'),
