...
export const fetchVibePrompt = async (
    ...
    const LOCAL_ONLY_COMPONENTS = ['cinematic-navbar', 'floating-dark-capsule', 'minimal-ai-capsule', 'pill-navbar', 'modern-dark', 'split-navigation-nav', 'awwwards-nav', 'haul-footer', 'vize-footer', 'alpine-footer', 'leeuwarder-golfclub', 'community-newsletter'];
